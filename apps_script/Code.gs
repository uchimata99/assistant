...
function chat_(b) {
  ...
  const system = [
    ...
    'איך למלא: anchor הוא התאריך של המועד עצמו, בשנה הנוכחית ולא בשנה הבאה. lead הוא מספר הימים שצריך להתריע מראש. "שלושה שבועות לפני יום ההולדת ב-18 באוגוסט" פירושו anchor של ה-18 באוגוסט ו-lead=21 — ולא anchor של סוף יולי. ברירת מחדל ל-lead היא 7.',
